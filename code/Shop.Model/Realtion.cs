...
namespace Shop.Model
{
    ...
    public partial class Realtion : Entity, IModel
    {
        ...
        private decimal _Realtion_Discount;
        ...
        public decimal Realtion_Discount
        {
            get { return _Realtion_Discount; }
            set
            {
                OnPropertyValueChange(_.Realtion_Discount, _Realtion_Discount, value);
                _Realtion_Discount = value;
            }
        }
        ...
        protected override void SetValues(IRowReader reader)
        {
            ...
            if ((false == reader.IsDBNull(_.Realtion_Discount)))
            {
                this._Realtion_Discount = reader.GetDecimal(_.Realtion_Discount);
            }
        ...
        public class _
        {
            ...
            /// 折扣 -  数据类型:decimal
            /// </summary>
            public static Field Realtion_Discount = new Field<Realtion>("Realtion_Discount");
