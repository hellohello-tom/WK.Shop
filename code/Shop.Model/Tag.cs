...
namespace Shop.Model
{
    ...
    public partial class Tag : Entity, IModel
    {
        ...
        {
            get { return _Tag_Status; }
            set
            {
                OnPropertyValueChange(_.Tag_Status, _Tag_Status, value);
                _Tag_Status = value;
            }
        }
        ...
        protected override void SetValues(IRowReader reader)
        {
            ...
            if ((false == reader.IsDBNull(_.Tag_Status)))
            {
                this._Tag_Status = reader.GetInt32(_.Tag_Status);
            }
        ...
        public class _
        {
            ...
            /// <summary>
            /// 字段名:Tag_Status -  数据类型:int
            /// </summary>
            public static Field Tag_Status = new Field<Tag>("Tag_Status");
