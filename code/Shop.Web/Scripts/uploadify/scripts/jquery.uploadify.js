        ...
        init: function (options, swfUploadOptions) {
            ...
            return this.each(function () {
                ...
                var settings = $.extend({
                    ...
                    method: 'pointer',             // The method to use when sending files to the server-side upload script
